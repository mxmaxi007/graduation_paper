...
\begin{figure}[htb] % use float package if you want it here
    \centering
    \includegraphics[height=10cm, width=15cm]{myfigures/cnn_1_layer}
...
\begin{figure}[htb] % use float package if you want it here
    \centering
    \includegraphics[height=10cm, width=15cm]{myfigures/cnn_2_layer}
...
\begin{figure}[htb] % use float package if you want it here
    \centering
    \includegraphics[height=10cm, width=15cm]{myfigures/cnn_layer_pooling}
...
\begin{figure}[htb] % use float package if you want it here
    \centering
    \includegraphics[height=10cm, width=15cm]{myfigures/rnn}
    \caption{循环神经网络}
    \label{fig:rnn}
\end{figure}
