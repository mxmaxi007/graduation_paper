...
\begin{minipage}{0.3\textwidth}
    \cente  ring
    \includegraphics[height=4cm]{myfigures/rnn_out_var_ang}
    \centerline{(a) 愤怒}\medskip
\end{minipage}\hfill
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[height=4cm]{myfigures/rnn_out_var_hap}
    \centerline{(b) 高兴}\medskip
\end{minipage}
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[height=4cm]{myfigures/rnn_out_var_sad}
